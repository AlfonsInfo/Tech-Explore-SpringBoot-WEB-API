...
public class GlobalExceptionHandler {
    ...
    public ResMessageDto<String> handleNotFoundException(DataNotFoundException exception) {
        return new ResMessageDto<>(HttpStatus.NO_CONTENT.value(),  exception.getMessage(),null);
    }
